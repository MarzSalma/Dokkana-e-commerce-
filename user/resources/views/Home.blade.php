...
@endif
  ...
  <div class="container-fluid">
        ...
        <div class="banner-blocks">
          ...
          <div class="banner-ad large bg-info block-1">
            ...
            <div class="swiper main-swiper">
                ...
                <div class="swiper-slide">
                  <div class="row banner-content p-5">
                    <div class="content-wrapper col-md-7">
                      <div class="categories my-3">100% original</div>
                      <h3 class="display-4">Explorez la gamme.</h3>
                      <p>
                      "Découvrez la technologie de pointe à portée de main : smartphones innovants, performances exceptionnelles, et designs élégants, tout en un clic !"
                      </p>
              ...
              <div class="banner-ad bg-success-subtle block-2" style="background:url('images/image.png') no-repeat;background-position: right ">
                <div class="row banner-content p-4">

                  <div class="content-wrapper col-md-7">
                    <div class="categories sale mb-3 pb-3">Number One</div>
                    <h3 class="banner-title">Biggest opportunities</h3>
              ...
              <div class="banner-ad bg-danger block-3" style="background:url('images/pc.png') no-repeat;background-position: right ">
                <div class="row banner-content p-5">

                  <div class="content-wrapper col-md-7">
                    <div class="categories sale mb-3 pb-3">Best seller</div>
                    <h3 class="item-title">Best Products</h3>
                    <a href="#" class="d-flex align-items-center nav-link">Shop Collection <svg width="24" height="24"><use xlink:href="#arrow-right"></use></svg></a>
                  </div>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
    <div class="col-md-12">
        <div class="category-box-container d-flex flex-wrap gap-3">
            @foreach(\App\Models\Category::all() as $category)
                <div class="category-box text-center p-3" style="border: 1px solid #ddd; border-radius: 8px; width: 150px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
                    <a href="{{ url('category/' . $category->id) }}" class="category-item d-block text-decoration-none text-dark">
          ...
          <div class="product-item swiper-slide">
            ...
            <figure>
              <a href="{{ url('product/' . $product->id) }}" title="{{ $product->name }}">
                ...
                @else
                  <img src="https://via.placeholder.com/300" class="tab-image" alt="Placeholder">
                @endif
              </a>
            </figure>
            ...
            <!-- Gestion de la quantité et bouton Ajouter au panier -->
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-6 copyright">
            <p>© 2025 Salma Merzoug. All rights reserved.</p>
          </div>
          <
        </div>
      </div>
